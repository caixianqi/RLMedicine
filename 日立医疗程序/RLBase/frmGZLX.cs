...
namespace RLBase
{
    public partial class frmGZLX : FormChildBase, Bao.Interface.IU8Contral
    {/// <summary>
        /// 所要查询的数据表名
        /// </summary>
        private const string TABLENAME = "BaseFaultType";
        ...
        /// <param name="e"></param>
        private void frmGZLX_Load(object sender, EventArgs e)
        {
        }
