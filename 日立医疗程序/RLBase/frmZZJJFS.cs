...
namespace RLBase
{
    public partial class frmZZJJFS : FormChildBase, Bao.Interface.IU8Contral
    {
        /// <summary>
        /// 所要查询的数据表名
        /// </summary>
        private const string TABLENAME = "BaseFinalSolution";
        ...
        /// <param name="e"></param>
        private void frmZZJJFS_Load(object sender, EventArgs e)
        {
        }
