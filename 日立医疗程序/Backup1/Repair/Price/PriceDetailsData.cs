...
namespace Repair
{
    class PriceDetailsData:Bao.BillBase.EntityTableItem
    {
     ...
     VALUES ";
            ...
            sql = sql + "('" + row1["AutoID"].ToString() + "','" + row1["PriceID"].ToString() + "','" + row1["InventoryCode"].ToString() + "','" + row1["InventoryName"].ToString() + "','" + row1["Type"].ToString() + "'," + row1["Money"].ToString() + ",'" + row1["IsReturn"].ToString() + "','" + row1["InventoryEngName"].ToString() + "','" + row1["InventoryStd"].ToString() + "'," + row1["InventoryNum"].ToString() + ")";
