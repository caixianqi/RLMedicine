...
namespace Bao.BillBase.Audit
{
    ...
    /// </summary>
    public partial class FrmJFWAuditFlowSet : Bao.BillBase.LookUpBasis, IChildForm,Bao.BillBase.Auditing.IAuditFlowSet
    {
        ...
        public FrmJFWAuditFlowSet(string funId,string flowFlag)
        {
            InitializeComponent();
            funcId = funId;
        ...
        public void dataBindingAuditDefin()
        {
            ...
            this.gridControlAuditDefine.DataSource = AuditBillFlowManager.GetAuditFlwDefines(FuncId, flowFlag);
        }
        #endregion
        ...
        private void toolBarBill1_OnBaoDelete(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(frmInput, "删除不成功，请确认删除记录"
                ...
                if (isNew)   //添加
                {
                    try
                    {
                        ...
                        AuditBillFlowManager.InsertAuditFlowDefin(frmInput.txtFunctionId.Text.Trim(),
                            auditNode, auditType, sortId, auCycle, managerUserId, flowFlag, "");
                        //清空文本
                ...
                else if(isUpdate)                                     //更新
                {
                    ...
                    try
                    {
                        ...
                        AuditBillFlowManager.ModifyAuditFlowDefin(
                            ...
                            , auditType.Trim(), Convert.ToInt32(frmInput.txtSortId.Text.Trim()), auCycle, managerUserId, flowFlag, "");
                        //启用
