...
namespace BillBase.AuthUser
{
    ...
    public class AuthorizationUser
    {
        ...
        public static void AuthUser(string autoUserId,string functionId,FrmLookUp.ToolBarBill toolBarBill) 
        {
            ...
            //增加
            AuthEnable(toolBarBill.BtnAddNew, "增加"); 
            //修改
            AuthEnable(toolBarBill.BtnModify, "修改"); 
            //保存
            AuthEnable(toolBarBill.BtnSave, "保存"); 
            //提交
            AuthEnable(toolBarBill.BtnUpLoad, "提交");
            //收回
            AuthEnable(toolBarBill.BtnUnUpLoad,"收回");
            //删除
        ...
        /// <returns></returns>
        public static void AuthEnable(System.Windows.Forms.ToolStripButton btn, string btnName)
        {
            //如果查询该名称，某个按钮可用
