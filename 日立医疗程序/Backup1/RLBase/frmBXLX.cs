...
namespace RLBase
{
    public partial class frmBXLX : FormChildBase, Bao.Interface.IU8Contral
    {/// <summary>
        /// 所要查询的数据表名
        /// </summary>
        private const string TABLENAME = "BaseGuaranteeType";
        ...
        /// <param name="e"></param>
        private void frmBXLX_Load(object sender, EventArgs e)
        {
        }
