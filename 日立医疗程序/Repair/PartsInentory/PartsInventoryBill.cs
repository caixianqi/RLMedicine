...
namespace Repair
{
    public class PartsInventoryBill :Bao.BillBase.BillBase
    {
        ...
        public void CheckData()
        {
            ...
            System.Data.DataRow tmp = this.EntityTables[0].Table.Rows[0];
            err += CheckIsNull(tmp["RepairTypeNew"], "维修类别不能为空");
            ...
            this.EntityTables[2].Table.AcceptChanges();
        ...
        public override void NewBefor()
        {
            ...
            if (RiLiGlobal.RiLiDataAcc.RiLiExecuteScalar("select ApplicationPersonCode from PartsApplication where PartsApplicationID = '" + partid + "'") == string.Empty)
            {
