...
namespace Repair
{
    class RepairMissionBill : Bao.BillBase.BillBase
    {
        ...
        public void CheckData()
        {
            ...
            mesg += CheckIsNull(maindata["RepairTypeNew"], "维修类型不能为空");

            mesg += CheckIsNull(maindata["CustomerManagerName"], "客服经理不能为空");
            ...
            //dtimefh 本货发货日期
            //DateTime dtimefh = DateTime.Parse(maindata["dtimefh"].ToString());

            //dtimegc GC出货日期
            //DateTime dtimegc = DateTime.Parse(maindata["dtimegc"].ToString());
            ...
            //&& UFBaseLib.BusLib.BaseInfo.userRole
            //if (maindata["RepairTypeNew"].ToString() == "G" )
            //{
            //    mesg += "[维修类型不能选[G-苦情]]";
            //}
