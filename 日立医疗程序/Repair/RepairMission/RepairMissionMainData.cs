    ...
    class RepairMissionMainData :Bao.BillBase.EntityTableMain
    {
        public override string InsertSQL(string BillId, System.Data.DataRow row1)
        {
           ...
           ,[CustomerDepartmentCode]
            ...
            ,[City]
            ,[Color]
            ,[RepairtypeNew] ,[dtimefh],[dtimegc] ,[dtimefhbx] ,[dtimegcbx] ,[dtimeazbx],[tdbxyd],[jqjbcode],[MachineType],[MachineLevel],[MachineModel],[xsCusName],[ProductLine],guaranteeNo )
     VALUES" + "(" +
        ...
        + "'" + row1["fSN2"].ToString() + "',"
         ...
         + "'" + row1["ZoneCode"].ToString() + "',"
              ...
              + "','" + row1["xsCusName"].ToString() + "','" + row1["ProductLine"].ToString() + "','" + row1["guaranteeNo"].ToString() + "')";
                          ...
                          "',[dtimeazbx] = '" + row1["dtimeazbx_t"].ToString() +
                           "',[tdbxyd] = '" + row1["tdbxyd"].ToString() +
                            "',[AuditMissonUser] = '" + row1["AuditMissonUser"].ToString() +
                             ...
                             "',[guaranteeNo] = '" + row1["guaranteeNo"].ToString() +
