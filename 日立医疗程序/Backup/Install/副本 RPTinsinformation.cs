...
namespace Install
{
    public partial class RPTinsinformationback  : Bao.FormChildBase, Bao.Interface.IU8Contral
    {
        ...
        private void TaskListInite()
        {
            ...
            if (iLoad == 0)
            {   //初始不加载数据
                tasksql = @"select I.tInsCode,tInsType,tCusName,tRegName,tRegCode,'' as '大区',tAddress,fPostCode,fCliManger,tComPhone,
