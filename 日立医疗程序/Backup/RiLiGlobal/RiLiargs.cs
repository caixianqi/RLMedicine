            ...
            try
            {
                if (args.Length > 0)
                {
                    ...
                    System.Data.SqlClient.SqlConnection conn = new
                                        System.Data.SqlClient.SqlConnection(RiLiGlobal.RiLiargs.formatConnection(args[0].Split('|')[3].Replace("~", " ")));
                    RiLiGlobal.RiLiDataAcc.MainConn = conn;
                    RiLiGlobal.RiLiDataAcc.MainConn.Open();
                ...
                else
                {
                    ...
                    UFBaseLib.BusLib.BaseInfo.operDate = RiLiGlobal.RiLiDataAcc.GetNow().Date.ToLongDateString ();
