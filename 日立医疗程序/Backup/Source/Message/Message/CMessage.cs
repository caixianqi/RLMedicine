...
namespace Bao.Message
{
    public class CMessage
    {
        ...
        /// <param name="FunctionId">功能编号</param>
        /// <param name="BillKeyId">单据编号</param>
        public static void SendMessageToRoleNoDepartment(string msgTitle, string msgBody, string DescRoleCode,  string SourceUserId, string FunctionId, string BillKeyId)
        {
