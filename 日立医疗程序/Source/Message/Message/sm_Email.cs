    ...
    public class sm_Email
    {
         /// <summary>
            ...
            public static string SendEmail(System.Collections.ArrayList mailTo, string subject, string body, bool bodyHTML, int priority)
            {
                ...
                string mailPwd = "HMGC0001";     //发件人的密码

                string mailTrueName = "售后"; //发件人的姓名
                string mailForm = "shouhou@hmgc.cn";    //发件人的邮箱


                //string smtp = "smtp.163.com";        //发信人所用邮箱的服务器
                //string mailUser = "tyx06";    //发件人的用户名
                //string mailPwd = "tyx7731";     //发件人的密码

                //string mailTrueName = "tyx06"; //发件人的姓名
                //string mailForm = "tyx06@163.com";    //发件人的邮箱

                System.Net.Mail.MailMessage msg = new System.Net.Mail.MailMessage();
                //msg.To.Add("tyx06@163.com");
                ...
                msg.Body = body;
                msg.BodyEncoding = System.Text.Encoding.UTF8; //System.Text.Encoding.UTF8;
